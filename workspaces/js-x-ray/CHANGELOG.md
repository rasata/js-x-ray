...
- [#540](https://github.com/NodeSecure/js-x-ray/pull/540) [`f548a44`](https://github.com/NodeSecure/js-x-ray/commit/f548a4489dd05d8bc4377e92f70a025faa9d9585) Thanks [@fraxken](https://github.com/fraxken)! - Exclude d.ts from EFA to avoid error and add .ts detection to automatically load TsSourceParser when required
